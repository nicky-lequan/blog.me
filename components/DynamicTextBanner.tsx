...
export default function HomeBanner(): JSX.Element {
  ...
  return (
    <div className="px-8 py-20 flex flex-col justify-center bg-gradient-to-r from-blue-100 dark:from-[#35155D]/70 shadow-md shadow-current dark:shadow-gray-800 rounded-xl">
      ...
      <p>
        ...
        It always comes with sense of conquest in the end, and that very feeling
        is what makes me keep hustling.
      </p>
    </div>
  );
}
