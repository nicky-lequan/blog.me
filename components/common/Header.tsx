...
export function H1({className, children}: HeaderProps): JSX.Element {
  return (
    <h1
      className={`${
        className ?? ''
      } px-4 py-3 font-bold text-5xl bg-gradient-to-r from-indigo-600/30 to-70% rounded-xl`}>
      {children}
    </h1>
  );
}
...
export function H2({className, children}: HeaderProps): JSX.Element {
  return (
    <h2
      className={`${
        className ?? ''
      } px-4 py-2 font-bold text-4xl bg-gradient-to-r from-indigo-700/30 to-60% rounded-xl`}>
      {children}
    </h2>
  );
}
...
export function H3({className, children}: HeaderProps): JSX.Element {
  return (
    <h3
      className={`${
        className ?? ''
      } px-4 py-2 font-bold text-3xl bg-gradient-to-r from-indigo-700/30 to-50% rounded-xl`}>
      {children}
    </h3>
  );
}
