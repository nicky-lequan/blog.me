    ...
    items: [
      {
        ...
        desc: '[Academic] Bitcoin price prediction with market indicators and google trend using regression models & LSTM RNN',
      },
      {
        ...
        desc: '[Academic] Reflex agent trained with reinforcement learning(Q-learning). This agent plays coin drop game implemented using pygame module.',
      },
      {
        ...
        desc: '[Academic] NLP for Korean words. Returns whether a given {Entity, Concept} pair is in "is-a" relationship or not.',
      },
    ],
  },
  {
