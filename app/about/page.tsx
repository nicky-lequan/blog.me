    ...
    <section className="relative w-full h-screen mx-auto">
      <div className="sm:px-16 px-6 absolute inset-0 top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5">
        ...
        <div>
          ...
          <p className="mt-2 text-gray-700 dark:text-gray-500 font-medium text-[10px] xs:text-[14px] sm:text-[18px] lg:text-[24px] leading-[24px]">
            ...
            refer to the Skills section if you wish to see more. <br />
            I'm currently open to job opportunities by the way, especially those
            in Canada. So please don't hesitate to reach me if you're a manager,
            head hunter, or whatever your position is. Weight training, watching
